    ...
    <div className="bg-gray-100 min-h-screen flex items-center justify-center">
      <div className="mx-auto w-full px-4 sm:px-6 lg:px-8">
        <div className="mx-auto w-full py-16 sm:py-24 lg:py-32">
          <h2 className="text-4xl font-bold text-gray-900">Welcome to react animation demostration</h2>
          <p className="text-base text-gray-900">

          Denne blogserie dækker tre sektioner, der hver fokuserer på forskellige aspekter af at 
          skabe animerede webapplikationer ved hjælp af React. I alle sektioner anvendes Tailwind som framework for at sikre brugervenlighed og enkelhed i prototypen.
